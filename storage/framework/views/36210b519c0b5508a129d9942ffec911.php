...
<body class="min-h-screen flex bg-slate-50 text-slate-800">
    ...
    <div class="flex-1 flex items-center justify-center p-8 bg-slate-50">
        <div class="w-full max-w-md fade-in">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 mb-10">
            ...
            <?php if(session('success')): ?>
                <div class="mb-4 p-4 bg-cyan-50 border border-cyan-200 rounded-xl text-cyan-700 text-sm font-medium"><i class="fas fa-check-circle mr-2 text-cyan-600"></i><?php echo e(session('success')); ?></div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="nama@polimicro.ac.id" class="w-full pl-11 pr-4 py-3.5 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition">
                    </div>
                </div>
                <div>
                ...
                <div class="flex items-center justify-between text-sm">
                    ...
                    <a href="<?php echo e(route('forgot-password')); ?>" class="text-cyan-600 font-semibold hover:text-cyan-700">Lupa Password?</a>
                </div>
            ...
            <p class="text-center text-slate-500 mt-6">Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-cyan-600 font-semibold hover:text-cyan-700">Daftar Sekarang</a></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\polimicro\resources\views/auth/login.blade.php ENDPATH**/ ?>