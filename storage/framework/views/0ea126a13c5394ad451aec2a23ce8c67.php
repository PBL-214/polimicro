...
<head>
  ...
  <meta property="og:image" content="<?php echo e(asset('design-assets/img/og-banner.png')); ?>">
  ...
  <nav id="navbar" class="fixed top-0 w-full z-50 transition-all duration-300 bg-transparent">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-8">
        ...
        <a href="<?php echo e(route('faq')); ?>" class="nav-link text-slate-600 hover:text-cyan-600 font-medium transition">FAQ</a>
      </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden px-6 pb-6 bg-slate-50 border-b border-slate-200">
      ...
      <a href="<?php echo e(route('faq')); ?>" class="block py-3 text-slate-600 hover:text-cyan-600 font-medium border-b border-slate-100">FAQ</a>
      <div class="mt-4">
        <?php if(auth()->guard()->check()): ?>
          <div class="flex flex-col gap-2">
            <a href="<?php echo e(route(auth()->user()->getDashboardRoute())); ?>" class="w-full text-center py-3 rounded-xl bg-slate-100 text-slate-700 font-medium hover:bg-slate-200 transition"><i class="fas fa-th-large mr-2"></i>Dasbor Saya</a>
            <form method="POST" action="<?php echo e(route('logout')); ?>">
              <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
          <div class="flex gap-3">
            <a href="<?php echo e(route('login')); ?>" class="flex-1 text-center py-2.5 rounded-xl border border-slate-300 text-slate-800 font-medium">Masuk</a>
            <a href="<?php echo e(route('register')); ?>" class="flex-1 text-center py-2.5 rounded-xl bg-cyan-600 text-white font-semibold">Daftar</a>
          </div>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-16 items-center relative z-10">
      <div>
        ...
        <div class="flex flex-wrap gap-4">
          <a href="<?php echo e(route('programs')); ?>" class="btn-primary"><i class="fas fa-rocket"></i> Jelajahi Program</a>
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div id="programs-grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="program-card bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <a href="<?php echo e(route('programs')); ?>" class="program-card-cta block w-full text-center py-2.5 rounded-xl bg-cyan-700 text-white text-sm font-semibold hover:bg-cyan-800 transition">
    ...
    <div class="max-w-7xl mx-auto px-6">
      <div class="grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div class="space-y-2 text-sm text-cyan-200">
            <a href="<?php echo e(route('login')); ?>" class="block hover:text-white transition">Masuk</a>
            <a href="<?php echo e(route('register')); ?>" class="block hover:text-white transition">Daftar</a>
          </div>
        </div>
        <div>
...
<?php /**PATH C:\laragon\www\polimicro\resources\views/welcome.blade.php ENDPATH**/ ?>