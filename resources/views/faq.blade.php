  ...
  <nav id="navbar" class="fixed top-0 w-full z-50 transition-all duration-300 bg-white/90 backdrop-blur border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center gap-8">
        <a href="{{ route('home') }}" class="nav-link text-slate-600 hover:text-cyan-600 font-medium transition">Beranda</a>
        <a href="{{ route('programs') }}" class="nav-link text-slate-600 hover:text-cyan-600 font-medium transition">Program</a>
        <a href="{{ route('faq') }}" class="nav-link text-cyan-600 font-semibold transition">FAQ</a>
      </div>
